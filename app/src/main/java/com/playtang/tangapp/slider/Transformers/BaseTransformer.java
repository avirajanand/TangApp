package com.playtang.tangapp.slider.Transformers;
 ...
 *
 * BaseTransformer implement {@link com.playtang.tangapp.slider.Tricks.ViewPagerEx.PageTransformer}
 * which is just same as {@link android.support.v4.view.ViewPager.PageTransformer}.
 *
 * After you call setPageTransformer(), transformPage() will be called by {@link com.playtang.tangapp.slider.Tricks.ViewPagerEx}
 * when your slider are animating.
 *
 * In onPreTransform() function, that will make {@link com.playtang.tangapp.slider.Animations.BaseAnimationInterface}
 * work.
 *

...
import com.playtang.tangapp.slider.Indicators.PagerIndicator;
import com.playtang.tangapp.slider.SliderTypes.BaseSliderView;
import com.playtang.tangapp.slider.Transformers.AccordionTransformer;
import com.playtang.tangapp.slider.Transformers.BackgroundToForegroundTransformer;
import com.playtang.tangapp.slider.Transformers.BaseTransformer;
import com.playtang.tangapp.slider.Transformers.CubeInTransformer;
import com.playtang.tangapp.slider.Transformers.DefaultTransformer;
import com.playtang.tangapp.slider.Transformers.DepthPageTransformer;
import com.playtang.tangapp.slider.Transformers.FadeTransformer;
import com.playtang.tangapp.slider.Transformers.FlipHorizontalTransformer;
import com.playtang.tangapp.slider.Transformers.FlipPageViewTransformer;
import com.playtang.tangapp.slider.Transformers.ForegroundToBackgroundTransformer;
import com.playtang.tangapp.slider.Transformers.RotateDownTransformer;
import com.playtang.tangapp.slider.Transformers.RotateUpTransformer;
import com.playtang.tangapp.slider.Transformers.StackTransformer;
import com.playtang.tangapp.slider.Transformers.TabletTransformer;
import com.playtang.tangapp.slider.Transformers.ZoomInTransformer;
import com.playtang.tangapp.slider.Transformers.ZoomOutSlideTransformer;
import com.playtang.tangapp.slider.Transformers.ZoomOutTransformer;
import com.playtang.tangapp.slider.Tricks.FixedSpeedScroller;
import com.playtang.tangapp.slider.Tricks.InfinitePagerAdapter;
...
/**
 * SliderLayout is compound layout. This is combined with {@link com.playtang.tangapp.slider.Indicators.PagerIndicator}
 * and {@link com.playtang.tangapp.slider.Tricks.ViewPagerEx} .
 *
...
private LinearLayout rightArrow;
    ...
    /**
     * {@link com.playtang.tangapp.slider.Tricks.ViewPagerEx} indicator.
     */
    private PagerIndicator mIndicator;


    /**
     * A timer and a TimerTask using to cycle the {@link com.playtang.tangapp.slider.Tricks.ViewPagerEx}.
     */
    private Timer mCycleTimer;
    private TimerTask mCycleTask;

    /**
     * For resuming the cycle, after user touch or click the {@link com.playtang.tangapp.slider.Tricks.ViewPagerEx}.
     */
    private Timer mResumingTimer;
    private TimerTask mResumingTask;

    /**
     * If {@link com.playtang.tangapp.slider.Tricks.ViewPagerEx} is Cycling
     */
    private boolean mCycling;

    /**
     * Determine if auto recover after user touch the {@link com.playtang.tangapp.slider.Tricks.ViewPagerEx}
     */
    ...
    /**
     * {@link com.playtang.tangapp.slider.Tricks.ViewPagerEx} transformer time span.
     */
    ...
    /**
     * Visibility of {@link com.playtang.tangapp.slider.Indicators.PagerIndicator}
     */
    private PagerIndicator.IndicatorVisibility mIndicatorVisibility = PagerIndicator.IndicatorVisibility.Visible;

    /**
     * {@link com.playtang.tangapp.slider.Tricks.ViewPagerEx} 's transformer
     */
    private BaseTransformer mViewPagerTransformer;

    /**
     * @see com.playtang.tangapp.slider.Animations.BaseAnimationInterface
     */
    private BaseAnimationInterface mCustomAnimation;

    /**
     * {@link com.playtang.tangapp.slider.Indicators.PagerIndicator} shape, rect or oval.
     */
    ...
    public SliderLayout(Context context, AttributeSet attrs) {
        this(context, attrs, com.playtang.tangapp.R.attr.SliderStyle);
}
    ...
    public SliderLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        leftArrow=(LinearLayout) findViewById(R.id.left_arrow);
        rightArrow=(LinearLayout) findViewById(R.id.right_arrow);
...
//ev.getSource();
     ...
     * {@link com.playtang.tangapp.slider.Animations.BaseAnimationInterface},
     * and you can see a example in {@link com.playtang.tangapp.slider.Animations.DescriptionAnimation}
     * @param animation
     */

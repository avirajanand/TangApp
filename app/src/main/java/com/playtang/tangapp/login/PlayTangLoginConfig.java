...
public class PlayTangLoginConfig {
  public static final String APP_LOGO = "com.playtang.tangapp.login.PlayTangLoginActivity.APP_LOGO";
  public static final String PARSE_LOGIN_ENABLED = "com.playtang.tangapp.login.PlayTangLoginActivity.PARSE_LOGIN_ENABLED";
  public static final String PARSE_LOGIN_BUTTON_TEXT = "com.playtang.tangapp.login.PlayTangLoginActivity.PARSE_LOGIN_BUTTON_TEXT";
  public static final String PARSE_SIGNUP_BUTTON_TEXT = "com.playtang.tangapp.login.PlayTangLoginActivity.PARSE_SIGNUP_BUTTON_TEXT";
  public static final String PARSE_LOGIN_HELP_TEXT = "com.playtang.tangapp.login.PlayTangLoginActivity.PARSE_LOGIN_HELP_TEXT";
  public static final String PARSE_LOGIN_INVALID_CREDENTIALS_TOAST_TEXT = "com.playtang.tangapp.login.PlayTangLoginActivity.PARSE_LOGIN_INVALID_CREDENTIALS_TEXT";
  public static final String PARSE_LOGIN_EMAIL_AS_USERNAME = "com.playtang.tangapp.login.PlayTangLoginActivity.PARSE_LOGIN_EMAIL_AS_USERNAME";
  public static final String PARSE_SIGNUP_MIN_PASSWORD_LENGTH = "com.playtang.tangapp.login.PlayTangLoginActivity.PARSE_SIGNUP_MIN_PASSWORD_LENGTH";
  public static final String PARSE_SIGNUP_SUBMIT_BUTTON_TEXT = "com.playtang.tangapp.login.PlayTangLoginActivity.PARSE_SIGNUP_SUBMIT_BUTTON_TEXT";
  public static final String FACEBOOK_LOGIN_ENABLED = "com.playtang.tangapp.login.PlayTangLoginActivity.FACEBOOK_LOGIN_ENABLED";
  public static final String FACEBOOK_LOGIN_BUTTON_TEXT = "com.playtang.tangapp.login.PlayTangLoginActivity.FACEBOOK_LOGIN_BUTTON_TEXT";
  public static final String GMAIL_LOGIN_BUTTON_TEXT = "com.playtang.tangapp.login.PlayTangLoginActivity.GMAIL_LOGIN_BUTTON_TEXT";
  public static final String FACEBOOK_LOGIN_PERMISSIONS = "com.playtang.tangapp.login.PlayTangLoginActivity.FACEBOOK_LOGIN_PERMISSIONS";
  public static final String TWITTER_LOGIN_ENABLED = "com.playtang.tangapp.login.PlayTangLoginActivity.TWITTER_LOGIN_ENABLED";
  public static final String TWITTER_LOGIN_BUTTON_TEXT = "com.playtang.tangapp.login.PlayTangLoginActivity.TWITTER_LOGIN_BUTTON_TEXT";

  // For internally serializing to/from string array (the public analog above is for resource from activity meta-data).
  private static final String FACEBOOK_LOGIN_PERMISSIONS_STRING_ARRAY = "com.playtang.tangapp.login.PlayTangLoginActivity.FACEBOOK_LOGIN_PERMISSIONS_STRING_ARRAY";

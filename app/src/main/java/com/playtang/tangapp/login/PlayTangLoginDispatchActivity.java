...
public abstract class PlayTangLoginDispatchActivity extends Activity {
  ...
  protected abstract Class<?> getTargetClass (boolean isLogin);
  ...
  final protected void onCreate(Bundle savedInstanceState) {
    super.onCreate(savedInstanceState);
      loginBundle=savedInstanceState;
      //Toast.makeText(getBaseContext(), "PlayTangLoginDispatchActivity Bundle isLogin:"+loginBundle.getBoolean("isLogin"), Toast.LENGTH_SHORT).show();
      runDispatch();
  }
  ...
  private void runDispatch() {
    if (ParseUser.getCurrentUser() != null) {
      debugLog(getString(com.playtang.tangapp.R.string.com_parse_ui_login_dispatch_user_logged_in) + getTargetClass());
      startActivityForResult(new Intent(this, getTargetClass()), TARGET_REQUEST);
    } else {
      debugLog(getString(com.playtang.tangapp.R.string.com_parse_ui_login_dispatch_user_not_logged_in));
  ...
  private void debugLog(String message) {
    ...
    private boolean isLoginbundle(Bundle b){
        return b.getBoolean("isLogin");
    }
}
